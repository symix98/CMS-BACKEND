...
/**
 * Criteria class for the {@link net.ccc.apps.campmanage.domain.RefEmployeeCompany} entity. This class is used
 * in {@link net.ccc.apps.campmanage.web.rest.RefEmployeeCompanyResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ref-employee-companies?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class RefEmployeeCompanyCriteria implements Serializable, Criteria {
    ...
    public RefEmployeeCompanyCriteria() {}

    public RefEmployeeCompanyCriteria(RefEmployeeCompanyCriteria other) {
    ...
    @Override
    public RefEmployeeCompanyCriteria copy() {
        return new RefEmployeeCompanyCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final RefEmployeeCompanyCriteria that = (RefEmployeeCompanyCriteria) o;
        return (
    ...
    public String toString() {
        return "RefEmployeeCompanyCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (code != null ? "code=" + code + ", " : "") +
            (name != null ? "name=" + name + ", " : "") +
