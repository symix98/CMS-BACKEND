...
/**
 * Criteria class for the {@link net.ccc.apps.campmanage.domain.RefInactiveReason} entity. This class is used
 * in {@link net.ccc.apps.campmanage.web.rest.RefInactiveReasonResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ref-inactive-reasons?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class RefInactiveReasonCriteria implements Serializable, Criteria {
    ...
    public RefInactiveReasonCriteria() {}

    public RefInactiveReasonCriteria(RefInactiveReasonCriteria other) {
    ...
    @Override
    public RefInactiveReasonCriteria copy() {
        return new RefInactiveReasonCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final RefInactiveReasonCriteria that = (RefInactiveReasonCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, code, name, description, category, createdBy, createdAt, modifyBy, modifyAt, employeeMasterId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "RefInactiveReasonCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (code != null ? "code=" + code + ", " : "") +
            (name != null ? "name=" + name + ", " : "") +
