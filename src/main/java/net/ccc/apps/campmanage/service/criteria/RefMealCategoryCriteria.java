...
/**
 * Criteria class for the {@link net.ccc.apps.campmanage.domain.RefMealCategory} entity. This class is used
 * in {@link net.ccc.apps.campmanage.web.rest.RefMealCategoryResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ref-meal-categories?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class RefMealCategoryCriteria implements Serializable, Criteria {
    ...
    public RefMealCategoryCriteria() {}

    public RefMealCategoryCriteria(RefMealCategoryCriteria other) {
    ...
    @Override
    public RefMealCategoryCriteria copy() {
        return new RefMealCategoryCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final RefMealCategoryCriteria that = (RefMealCategoryCriteria) o;
        return (
    ...
    public String toString() {
        return "RefMealCategoryCriteria{" +
            (id != null ? "id=" + id + ", " : "") +
            (code != null ? "code=" + code + ", " : "") +
            (name != null ? "name=" + name + ", " : "") +
