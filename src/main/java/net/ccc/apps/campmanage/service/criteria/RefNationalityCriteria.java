...
/**
 * Criteria class for the {@link net.ccc.apps.campmanage.domain.RefNationality} entity. This class is used
 * in {@link net.ccc.apps.campmanage.web.rest.RefNationalityResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ref-nationalities?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class RefNationalityCriteria implements Serializable, Criteria {
    ...
    public RefNationalityCriteria() {}

    public RefNationalityCriteria(RefNationalityCriteria other) {
    ...
    @Override
    public RefNationalityCriteria copy() {
        return new RefNationalityCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final RefNationalityCriteria that = (RefNationalityCriteria) o;
        return (
