...
/**
 * Criteria class for the {@link net.ccc.apps.campmanage.domain.RefProject} entity. This class is used
 * in {@link net.ccc.apps.campmanage.web.rest.RefProjectResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /ref-projects?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
public class RefProjectCriteria implements Serializable, Criteria {
    ...
    public RefProjectCriteria() {}

    public RefProjectCriteria(RefProjectCriteria other) {
    ...
    @Override
    public RefProjectCriteria copy() {
        return new RefProjectCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final RefProjectCriteria that = (RefProjectCriteria) o;
        return (
