...
import net.ccc.apps.campmanage.service.BookingQueryService;
...
/**
 * REST controller for managing {@link net.ccc.apps.campmanage.domain.Booking}.
 */
@RestController
@RequestMapping("/api")
public class BookingResource {
    ...
    private static final String ENTITY_NAME = "campmanagBooking";
