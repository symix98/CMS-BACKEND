...
import net.ccc.apps.campmanage.service.CompanyQueryService;
...
/**
 * REST controller for managing {@link net.ccc.apps.campmanage.domain.Company}.
 */
@RestController
@RequestMapping("/api")
public class CompanyResource {
    ...
    private static final String ENTITY_NAME = "campmanagCompany";
