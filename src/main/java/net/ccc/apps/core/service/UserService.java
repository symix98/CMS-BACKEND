...
import net.ccc.apps.config.Constants;
import net.ccc.apps.core.domain.Authority;
import net.ccc.apps.core.domain.User;
import net.ccc.apps.core.repository.AuthorityRepository;
import net.ccc.apps.core.repository.UserRepository;
import net.ccc.apps.security.SecurityUtils;
import net.ccc.apps.core.service.dto.AdminUserDTO;
import net.ccc.apps.core.service.dto.UserDTO;
...
public class UserService {
    ...
    public static User currentLoggedInUser() {
        ...
        if (authentication instanceof OAuth2AuthenticationToken) {
            ...
            user = getUser(oauthToken.getPrincipal().getAttributes());
        } else {
